...
% 2D VECTORS COMMAND USING PGF AND TIKZ GRAPHICS, WORKS IN PGFPLOTS ENVIRONMENTS

\newcommand{\vecTwo}[3]%May fix errors
{
	\draw[->,#3] (#1) -- (#2);
}
...
\hskip 10pt% adds space between adjacent axes graphics
\begin{tikzpicture}
...
\end{tikzpicture}% Removes whitespace between adjacent math graphics!!!
\hskip 10pt
\begin{tikzpicture}
	...
	xlabel={$\theta$},
	ytick={0,...,4}]
	 	\vecTwo{0,0}{33.69006753,1.802775638}{black}
	 	\vecTwo{0,0}{56.30993247,3.605551275}{black}
	\end{polaraxis}
